...
@Composable
internal fun SignUpView(viewModel: SignUpViewModel, modifier: Modifier = Modifier) {
    val context = LocalContext.current

    val displayNameState = viewModel.displayNameStateFlow.collectAsState()
    ...
    val buttonEnabled = displayNameState.value.isNotEmpty()
            && emailAddressState.value.isNotEmpty()
